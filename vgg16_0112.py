...
def test(img_dir, classes, count='ensemble'):
    Learning_rate = 0.00017
    batch_size = 256
    scale_resize = [32, 195]
    ...
    models = ['iron_vgg16_model1-86', 'iron_vgg16_model2-87',
              'iron_vgg16_model3-88', 'iron_vgg16_model4-86',
              'iron_vgg16_model5-88', 'iron_vgg16_model6-91',
              'iron_vgg16_model7-92', 'iron_vgg16_model8-86',
              'iron_vgg16_model9-89', 'iron_vgg16_model10-87']
